...
| ---------------------- | --------------- | ----------------------------------- | ------- |
| **PROFILE**            | 323             | $`30\cdot 10^6`$ (MAU*2)            | 9 Гб    |
...
| **ADDRESS**            | 81              | $`45\cdot 10^6`$  (MAU*3)           | 4 Гб    |
| **CATEGORY**           | 24              | $`10^4`$                            | -       |
...
Используем СУБД PostgreSQL для всех стандартных БД и паттерн Database Per Service.
...
***Card DB, User Session DB, ML-Ranking FeatureStore DB — Redis***
...
В Clickhouse пишутся асинхронно данные для аналитики и обучения ML.
...
В итоге, для таблицы `PRODUCT` чтобы держать 65K RPS можно сделать 64 шарда: 1 синхронная реплика и 2 асинхронных реплики, 100 партиций: product_0, product_1, product_2...
