...
| **CART**               | Информация о корзинах пользователей       | 230 QPS | 192QPS  |
| **SHOPPING_CART_ITEM** | Информация о товарах входящих в корзину   | 500 QPS | 192QPS  |
...
| Table                  | Поле       | Операция | Структура данных |
| ---------------------- | ---------- | -------- | ---------------- |
| **PROFILE**            |            |          |                  |
| **PRODUCT**            |            |          |                  |
| **COMMENT**            | product_id | update   | B-дерево         |
| **ORDER_INFO**         |            |          |                  |
| **STATUS**             |            |          |                  |
| **ORDER_ITEM**         |            |          |                  |
| **ADDRESS**            |            |          |                  |
...
Используем СУБД PostgreSQL и паттерн Database Per Service.
