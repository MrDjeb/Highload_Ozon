...
Поиск и подсказки - помогаем найти наиболее
релевантные товары по пользовательскому запросу
...
В рамках __MVP__ ограничимся __FBS__ и __rFBS__ видом фулфилмента, откажемся от __FBO__, т.е. от хранения товара на собственных складах.

__FBS__ (Fulfillment by Seller) - 
cеллер хранит товар на собственном складе,
самомостоятельно собирает заказ и передаёте заказ в службу доставки.

__rFBS__ (real FBS) — схема работы, при которой продавец сам отвечает за хранение и доставку товара.
 

Служба доставки, 
На разрабатываемом маркетплейсе действует один вид фулфилмента -
...
Открытых источников информации нет, опросив знакомых пользователей сервиса, составим сценарий посещения сайта одним пользователем в течение дня.
