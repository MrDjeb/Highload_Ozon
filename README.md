...
* Service mesh на Istio - предоставляет проверки работоспособности, повторные запросы, таймауты и размыкание цепи (curcuit breaking, Istio реализует процедуру Pool Ejection), повышает надёжность приложения.
